...
export default function Dashboard({ userId, onOpenArtifact }) {
        ...
        <div className="lg:col-span-8 liquid-glass rounded-[2.5rem] p-10 overflow-hidden relative">
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-8">
              ...
              <button className="text-sm text-white/40 hover:text-white/80 transition-colors flex items-center gap-2">
                View Library
              ...
              <div className="space-y-4">
                {userData.uploads.slice(0, 4).map((upload, idx) => (
                  <div 
                    ...
                    className="flex items-center justify-between p-5 rounded-3xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] cursor-pointer transition-all group"
                  >
